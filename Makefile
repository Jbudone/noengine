...
SOURCE_COMMON = lib_logger.o k_memory.o lib_containers.o lib_shdmgr.o lib_resmgr.o  k_camera.o k_mesh.o k_entity.o k_world.o lib_math.o soil.a
...
LIBS = -L/usr/local/lib/ -L/usr/local/lib64/ -lGLEW -lGLU -lGL -lglut -lcurses
