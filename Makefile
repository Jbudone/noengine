...
SOURCE_COMMON = lib_logger.o k_memory.o lib_containers.o lib_shdmgr.o lib_resmgr.o k_geometry.o k_terrain.o k_camera.o k_mesh.o k_entity.o k_world.o lib_math.o k_ui.o soil.a
